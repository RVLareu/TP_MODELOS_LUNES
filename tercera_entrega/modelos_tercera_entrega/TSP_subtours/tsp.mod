...
//Solucion inicial
int ordenInicial[Cities] = [44, 71, 45, 4, 68, 91, 13, 74, 31, 27, 49, 72, 80, 14, 77, 15, 78, 59, 16, 79, 88, 94, 10, 63, 48, 73, 76, 87, 1, 98, 34, 30, 84, 7, 8, 89, 96, 35, 93, 52, 33, 92, 54, 46, 90, 56, 26, 75, 18, 85, 65, 55, 58, 50, 70, 86, 29, 81, 25, 20, 51, 43, 67, 32, 23, 38, 41, 57, 39, 60, 66, 17, 11, 61, 36, 69, 24, 12, 53, 40, 42, 9, 28, 6, 37, 2, 19, 99, 47, 83, 97, 100, 5, 95, 82, 3, 62, 22, 21, 64];
int values[Edges];
execute {
for ( var e in Edges) {
values[e] = 0;
